...
En este gráfico se aprecia que para valores de masa corporal mayores a 5600 gramos aumentamos el largo de la aleta con valores atípicos. Es decir valores que se alejan del comportamiento normal de la variable.
...
Comparemos el ajuste del modelo lineal ajustando en un dataset de train con y son outliers:
...
```{r}
lm_vs_lm_coeficients(lineal_model_1, robust_lineal_model_3) 
```
...
lm_vs_br_models_validation(lineal_model_3, bayesion_model_3, params_3, vars_3, test_set)
```
