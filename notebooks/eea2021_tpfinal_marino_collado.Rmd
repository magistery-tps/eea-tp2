...
```{r}
outliers(dataset, column='surface_covered')
```

```{r}
outliers(dataset, column='surface_total')
```

```{r}
outliers(dataset, column='bathrooms')
```


```{r}
outliers(dataset, column='rooms')
```

```{r}
outliers(dataset, column='price')
```
